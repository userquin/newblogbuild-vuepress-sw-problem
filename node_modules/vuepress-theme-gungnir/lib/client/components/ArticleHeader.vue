    ...
    <div class="article-header-content">
      ...
      <div class="article-icons">
        ...
        >
          ...
          <span>✍️&ensp;{{ frontmatter.author || personalInfo.name }}</span>
        </div>

        <div v-if="frontmatter.date" class="article-icon">
          <span>🗓️&ensp;{{ formateDateString(frontmatter.date) }}</span>
        </div>

        <div v-if="page.readingTime" class="article-icon">
          <!-- <VIcon name="ri-timer-line" /> -->
          <span>⏰&ensp;{{ page.readingTime.minutes }} min</span>
        </div>
      </div>
...
// Use local svg icon
// import { OiGitCompare, RiBook2Fill, GiAbstract002 } from "oh-vue-icons/icons";

import { OhVueIcon, addIcons } from "oh-vue-icons";
import { FcAlarmClock , RiZhihuFill } from "oh-vue-icons/icons";

addIcons(FcAlarmClock , RiZhihuFill);
