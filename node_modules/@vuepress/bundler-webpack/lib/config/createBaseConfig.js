...
const createBaseConfig = async ({ app, options, isBuild, isServer, }) => {
     ...
     * mode
     */
    (0, handleMode_1.handleMode)({ app, config, isBuild });
    /**
     * node
     */
     ...
     * devtool
     */
    (0, handleDevtool_1.handleDevtool)({ app, config, isBuild });
    /**
     * resolve
     */
     ...
     * plugins
     */
    await (0, handlePluginDefine_1.handlePluginDefine)({ app, config, isBuild, isServer });
    /**
     * other options
     */
