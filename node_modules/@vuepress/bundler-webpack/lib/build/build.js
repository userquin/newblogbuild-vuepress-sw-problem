...
const build = async (options, app) => {
    ...
    await (0, utils_1.withSpinner)('Rendering pages')(async () => {
        ...
        const clientManifestPath = app.dir.temp(createClientConfig_1.clientManifestFilename);
        delete require.cache[clientManifestPath];
        const clientManifest = (await Promise.resolve().then(() => require(clientManifestPath)));
        ...
        const { createVueApp } = (await Promise.resolve().then(() => require(serverEntryPath)));
        // create vue ssr app
